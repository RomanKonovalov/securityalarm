        ...
        return {
            ...
            template: function(/*element, attrs*/) {
                ...
                return '<div class="rg-range-picker" ng-class="{\'rg-range-picker-vertical\':vertical}">' +
                    ...
                    '<div uib-datepicker ng-model="data.date.from" class="clean-calendar" datepicker-options="data.date.options.from"></div>' +
                    '</div>' +
                    ...
                    '<div uib-datepicker ng-model="data.date.to" class="clean-calendar" datepicker-options="data.date.options.to"></div>' +
                    '</div>' +
                    '</div>' +
            ...
            link: function(scope, element, attrs) {
                ...
                if ( !angular.isUndefined(scope.onTimeChange()) && scope.data.hasTimeSliders ) {
                    ...
                    scope.$watch('data.date.from', timeChanges);
                    scope.$watch('data.date.to', timeChanges);
                }
                /**
                ...
                function updateMinAndMaxDate() {
                    ...
                    scope.data.date.options.from.minDate = new Date(_min);
                    scope.data.date.options.from.maxDate = scope.data.date.to;
                    // set max date
                    scope.data.date.max = new Date(_max);
                    scope.data.date.options.to.maxDate = new Date(_max);
                    scope.data.date.options.to.minDate = scope.data.date.from;
                }
